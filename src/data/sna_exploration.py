...
response_weight_slim_df = SnaDataWrangler.process_data_for_sna("response", 1.0, message_slim_df)
emoji_weight_slim_df = SnaDataWrangler.process_data_for_sna("emoji", 1.5, message_slim_df, emoji_slim_df)
quotation_weight_slim_df = SnaDataWrangler.process_data_for_sna("quotation", 2.0, message_slim_df)
